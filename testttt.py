...
if __name__ == "__main__":
    ...
    # Find all the faces and face enqcodings in the frame of video
        ...
        shapes_faces = [shape_predictor(frame, face) for face in face_locations]
        face_encodings = [np.array(face_recognition_model.compute_face_descriptor(image, face_pose, 1)) for face_pose in shapes_faces]
